...
// MATERIAL-UI
import { Avatar, Box, Button, Container, Grid, TextField, Tooltip, Typography, IconButton, Autocomplete } from "@mui/material"
...
const EditButton = ({ defaultState, saveAction, children }) => {
					...
					<SettingsContent>
						...
						<ContentGroup title="Profile">
							<ContentRow title="Avatar">
								<EditButton
									defaultState={<Avatar variant="square" url={currentUser.photoURL} sx={{ width: 64, height: 64 }} />}
									saveAction={() => { }}
								>
									<Grid container spacing={2}>
										<Grid item>
											<Avatar url={currentUser.photoURL} sx={{ width: 128, height: 128 }} />
										</Grid>
										<Grid item>
											...
											<SimpleTogglePanel title="or choose one of our defaults" isExpanded={true}>
												<DefaultAvatarPanel callback={() => { }} defaultAvatar={currentUser.photoURL} />
											</SimpleTogglePanel>
										</Grid>
									</Grid>
								</EditButton>
